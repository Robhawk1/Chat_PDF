...
def get_response(user_query, chat_history):
    ...
    llm = ChatOpenAI()
    #chain1 = self_ask_with_search  
    chain = prompt | self_ask_with_search | StrOutputParser()
...
if user_query is not None and user_query != "":
    ...
    with st.chat_message("AI"):
        response = st.chat_message("AI).write(get_response(user_query, st.session_state.chat_history))
